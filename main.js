...
function buscarSeg(buscado, array) {
    let busquedaListado = array.filter(
        (seguro) =>
            seguro.empresa.toLowerCase().includes(buscado.toLowerCase()) ||
            seguro.nombre.toLowerCase().includes(buscado.toLowerCase()) ||
            seguro.tipo.toLowerCase().includes(buscado.toLowerCase())
    );
